...
vi.mock("./db", () => {
  ...
  return {
    ...
    invalidateEmailAuthTokens: vi.fn(
      async (userId: number, purpose: string) => {
...
describe("register", () => {
  it(
    "creates an unverified account and sends a confirmation link",
    async () => {
      await register({
  ...
  it(
    "tells the owner, not the requester, when an address is taken",
    async () => {
      await register({
  ...
  it(
    "costs the same whether or not the address is taken",
    async () => {
...
describe("signIn", () => {
  ...
  it(
    "accepts the right password once the address is confirmed",
    async () => {
  ...
  it(
    "is case-insensitive about the address",
    async () => {
      await setUpVerifiedAccount();
      await expect(
        signIn({
  ...
  it(
    "says exactly the same thing for an address that has no account",
    async () => {
      await setUpVerifiedAccount();
  ...
  it(
    "still hashes when there is no account, so timing does not answer either",
    async () => {
  ...
  it(
    "will not sign in an account that has not confirmed its address",
    async () => {
      await register({
  ...
  it(
    "will not let a passwordless account be signed into with any password",
    async () => {
...
describe("password reset", () => {
  ...
  it(
    "sends a link for an address that has an account",
    async () => {
  ...
  it(
    "sets the new password and lets it sign in",
    async () => {
  ...
  it(
    "retires every other outstanding reset link once one is used",
    async () => {
  ...
  it(
    "counts a completed reset as confirming the address",
    async () => {
