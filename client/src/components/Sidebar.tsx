...
export function Sidebar({
      ...
      <div key={folder.id} className="mb-2">
        <div className="flex items-center gap-1 group">
          ...
          {isEditing ? (
            ...
            <>
              <div className="flex items-center gap-2 flex-1 px-2 py-1 rounded hover:bg-muted/50 cursor-pointer">
  ...
  return (
    <div className="w-64 h-full bg-card border-r border-border overflow-y-auto flex flex-col">
      {/* Header */}
      <div className="p-4 border-b border-border">
        <h2 className="text-lg font-bold text-foreground mb-3">My Workspace</h2>
        <Button
